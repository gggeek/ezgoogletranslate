...
<script type="text/javascript">
    ...
    var to_lang = '{$translation_list[$language_index].language_code||extract_left( 2 )}';
    var from_lang = '{if $is_translating_content}{$object.languages[$from_language].language_code||extract_left( 2 )}{/if}';
{literal}
    function translate( element, from, to )
    {
